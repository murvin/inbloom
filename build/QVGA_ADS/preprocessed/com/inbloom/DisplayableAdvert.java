...
public class DisplayableAdvert extends Form implements CommandListener, InneractiveAdEventsListener {
    ...
    class Worker extends Thread {
        ...
        int mTask;
        DisplayableAdvert mOwner;

        public Worker(DisplayableAdvert owner) {
            mOwner = owner;
        }
                ...
                try {
                    switch (mTask) {
                        ...
                        case DISPLAY_INTERSTITIAL_AD:
                            ...
                            IADView.displayInterstitialAd(midlet, APP_ID, interstitialData, DisplayableAdvert.this);
                            break;
                        ...
                        case GET_BANNER_AD:
                            ...
                            Ad = IADView.getBannerAdData(midlet, APP_ID, metaData);
                            Image retImg = null;
                            if (null != Ad) {
    ...
    public DisplayableAdvert(MIDlet midlet) {
