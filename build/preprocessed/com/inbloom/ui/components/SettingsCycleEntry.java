...
public class SettingsCycleEntry extends Panel implements IFocusable, ITouchEventListener, IUikitInputHandler {
    ...
    public SettingsCycleEntry(int width, String title, String description, String value, BitmapFont titleFont, BitmapFont descFont, ComponentStyle[] styles, boolean isLongVal, int fieldType, PatchPainter renderer) {
        super(width, 0);
        this.title = title;
